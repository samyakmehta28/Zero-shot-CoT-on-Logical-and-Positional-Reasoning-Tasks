...
def main():
    ...
    file_path = 'my_log/family_relationship_puzzle.json'
...
def parse_arguments():
    ...
    parser.add_argument(
        "--dataset", type=str, default="aqua", choices=["aqua", "gsm8k", "commonsensqa", "addsub", "multiarith",  "strategyqa", "svamp", "singleeq", "bigbench_date", "object_tracking", "coin_flip", "last_letters", "seating_arrangement","family_relationship_puzzle"], help="dataset used for experiment"
    )
    ...
    parser.add_argument(
        "--model", type=str, default="gpt3", choices=["gpt4", "gpt-4-turbo", "gpt-4o", "gpt-3.5-turbo"], help="model used for decoding. Note that 'gpt3' are the smallest models."
    )
    ...
    elif args.dataset == "seating_arrangement":
        args.dataset_path = "./dataset/seating_arrangement/data_seating.json"
        args.direct_answer_trigger = "\nNow, Just give me the final answer derived at the end. Response with answer: ${option number} and nothing else:\n "
    elif args.dataset == "family_relationship_puzzle":
        args.dataset_path = "./dataset/family_relationship_puzzle/family_relationship_puzzle.json"
        args.direct_answer_trigger = "\nNow, Just give me the final answer derived at the end. Response with answer: ${option number} and nothing else:\n "
    else:
